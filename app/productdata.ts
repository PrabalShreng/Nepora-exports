...
export const craftProducts = {
  Women: defineProducts([
    ...
    },
    {
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(63),
      descriptionImages: [asset(63), asset(63), asset(63)],
    },
     {
      slug: "craft-herringbone-weave-pashmina",
      name: "Herringbone Weave Pashmina",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(36),
      descriptionImages: [asset(36), asset(36), asset(36)],
    },
     {
      slug: "craft-herringbone-weave-pashmina",
      name: "Herringbone Weave Pashmina",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(66),
      descriptionImages: [asset(66), asset(66), asset(66)],
    },
    {
      slug: "craft-herringbone-weave-pashmina",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(75),
      descriptionImages: [asset(75), asset(75), asset(75)],
    },
    {
      slug: "craft-herringbone-weave-pashmina",
      name: "Pashmina Scarves",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(76),
      descriptionImages: [asset(76), asset(76), asset(76)],
    },
    {
      slug: "craft-herringbone-weave-pashmina",
      name: "Pashmina Scarves",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(77),
      descriptionImages: [asset(77), asset(77), asset(77)],
    },
    {
      slug: "craft-herringbone-weave-pashmina",
      name: "Pashmina Scarves",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(78),
      descriptionImages: [asset(78), asset(78), asset(78)],
    },
    {
      slug: "craft-herringbone-weave-pashmina",
      name: "Pashmina Wraps",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(79),
      descriptionImages: [asset(79), asset(79), asset(79)],
    },
    {
      slug: "craft-herringbone-weave-pashmina",
      name: "Pashmina Wraps",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(80),
      descriptionImages: [asset(80), asset(80), asset(80)],
    },
    {
      slug: "craft-herringbone-weave-pashmina",
      name: "Pashmina Wraps",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(81),
      descriptionImages: [asset(81), asset(81), asset(81)],
    },
    {
      slug: "craft-herringbone-weave-pashmina",
      name: "Pashmina Wraps",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(82),
      descriptionImages: [asset(82), asset(82), asset(82)],
    },
    {
      slug: "craft-herringbone-weave-pashmina",
      name: "Pashmina Wraps",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(83),
      descriptionImages: [asset(83), asset(83), asset(83)],
    },
    {
      slug: "craft-herringbone-weave-pashmina",
      name: "Pashmina Wraps",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(84),
      descriptionImages: [asset(84), asset(84), asset(84)],
    },
    {
      slug: "craft-herringbone-weave-pashmina",
      name: "Pashmina Wraps",
      ...
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(85),
      descriptionImages: [asset(85), asset(85), asset(85)],
    },
  ]),
  Men: defineProducts([
    {
    ...
    },
    {
      ...
      category: "Men",
      material: "Handwoven Pattern Pashmina",
    ...
    },
    {
      ...
      name: "Herringbone Weave Pashmina",
      category: "Men",
      material: "Handwoven Blanket Pashmina",
      description: "A herringbone weave creates a repeating chevron texture in this Pashmina.",
      notes: "Drape it over the shoulders or fold it into a layer around the neck.",
      mainImage: asset(46),
...
export const oneOfAKindProducts = defineProducts([
  ...
  },
  {
    ...
    mainImage: asset(46),
    descriptionImages: [asset(46), asset(46), asset(46)],
  },
  {
